...
function Navigation() {
    ...
    <>
      <li>
        <NavLink
          ...
          className={({ isActive }) =>
            isActive
              ? "text-black dark:text-white font-extrabold scale-110 duration-300"
              : ""
          }
        >
          Home
  ...
  return (
    <div
      className={`max-w-screen-2xl container mx-auto md:px-20 px-4 bg-slate-200 dark:bg-slate-900 fixed top-0 left-0 right-0 z-10 
    ${
      sticky
      ...
      <div className="navbar">
        <div className="navbar-start">
          <div className="dropdown">
            ...
            <ul
              tabIndex={0}
              className="menu menu-sm text-white dropdown-content bg-base-100 rounded-box z-[1] mt-3 w-52 p-2 shadow  font-bold"
            >
              {navItems}
            </ul>
          </div>
        ...
        <div className="navbar-end space-x-3">
          <div className="navbar-center hidden lg:flex">
            <ul className="menu menu-horizontal px-1 text-blue-900 dark:text-white">
              {navItems}
            </ul>
          </div>
